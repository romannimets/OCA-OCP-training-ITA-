...
/**
 * Implementazione della classe Leone che implementa l'interfaccia Correre.
 * La classe fornisce concrete implementazioni per i metodi astratti ereditati da Correre e Camminare.
 */
public class Leone implements Correre {
    ...
    /**
     * Implementazione del metodo getMaxVelocita() definito in Correre.
     * Nota: Questa implementazione sovrascrive quella di Camminare.
